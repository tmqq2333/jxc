...
public class proinout extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				tbzprice=Float.parseFloat(tbprice.toString())*Float.parseFloat(tbprocount.toString());
				Date time1=new Date();
			    SimpleDateFormat df1= new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			    String ctime=df1.format(time1);
				String strSql1=" insert into tbinout (opttype,proid,pronum,proname,protype,proimgurl,prooldnum,proaddnum,ctime,price,zprice) values (?,?,?,?,?,?,?,?,?,?,?)";
				...
				String strSql2="update tbcanpproduct set procount=procount-? where pronum=?";		
				//int procountres=Integer.parseInt(tbprocount)*Integer.parseInt(t);	
				List<Object> params2 = new ArrayList<Object>();			
				params2.add(tbprocount);
