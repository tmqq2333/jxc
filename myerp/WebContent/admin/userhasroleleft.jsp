...
<body>
<p class="path">当前位置：夜鹰进销存系统 >权限配置>待分配的角色</p>
<table class="tblist"  cellspacing="0" cellpadding="0">
<tr><td style="width:60px;"><input id="cbSelectAll" type="checkbox"/></td><td style="width:60px;">ID</td><td>角色名称</td></tr>
<%for (Map<String, Object> m : list) { %>
<tr><td class="tdcenter"><input type="checkbox" value="<%=m.get("id")%>"  name="select"></td>
<td><%=m.get("id")%></td><td><%=m.get("rolename")%></td></tr>
<%}%>

</table>
<div>  &nbsp;  <input id="addSelect" class="bgbtn2" type="button" value="添加"  /> &nbsp;&nbsp; 
 <%=pagestr%>  </div>
<script type="text/javascript" src="./js/jquery-1.11.0.js"></script>
    <script type="text/javascript">
        ...
        $("#addSelect").click(function () {
            ...
            s+= ",0";
            $.post("./ajax?" + Math.random(), { rnum: "3", idstr: s, userid: userid }, function (res) {
                location.reload();
