...
<html>
	...
	<body>
		<form action="../proadd" method="post" enctype="multipart/form-data">
			<p class="path">当前位置：夜鹰进销存系统/材料中心/新增材料</p>
			<table border="0" cellspacing="0" cellpadding="0" class="tb">
				...
				<tr><td class="lable">产地</td><td  id="address"><!-- <input type="text" name="address"/> --></td></tr>
		...
		<script src="../js/jquery-1.11.0.js" type="text/javascript" charset="utf-8"></script>
		 <script type="text/javascript">
 			...
 			$(function(){
 				...
 				$.post("./../ajax?" + Math.random(), { rnum:"10"}, function (data) {
 	                
 	               $("#address").html(data.msg10);
 	            });
